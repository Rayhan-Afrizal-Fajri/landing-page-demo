  ...
  return (
      <section id='beranda' className="container mx-auto px-8 hero grid md:grid-cols-2 pb-10 pt-24 gap-12 items-center grid-cols-1 relative min-h-[80vh]">
        ...
        <div className="relative w-full h-[420px] overflow-hidden rounded-2xl">
          ...
          <button
            onClick={prevSlide}
            className="w-10 h-auto absolute left-3 top-1/2 -translate-y-1/2 bg-black/40 text-white p-2 rounded-full hover:bg-black/60 transition"
          ...
          <button
            onClick={nextSlide}
            className="w-10 h-auto absolute right-3 top-1/2 -translate-y-1/2 bg-black/40 text-white p-2 rounded-full hover:bg-black/60 transition"
