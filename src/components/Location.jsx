                    ...
                    <div className="grid md:grid-cols-2 gap-4 mb-6">
                        <div className="flex items-center p-3 bg-gray-50 rounded-xl">
                            ...
                            <div>
                                ...
                                <div className="text-sm text-gray-600">+6281234567890</div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center p-3 bg-gray-50 rounded-xl">
                            ...
                            <div>
                                ...
                                <div className="text-sm text-gray-600">08:00 - 22:00 WIB</div>
                            </div>
                        </div>
                    </div>

                    <div className="grid md:grid-cols-2 gap-4">
                        <a href="https://www.google.com/maps?q={{ $firstCabang->latitude }},{{ $firstCabang->longitude }}" 
                            target="_blank"
                        ...
                        <a href="https://wa.me/+6281234567890?text=Halo%20Akrom%20Rental%2C%20saya%20ingin%20bertanya%20tentang%20lokasi%20dan%20jam%20operasional"
                            target="_blank"
